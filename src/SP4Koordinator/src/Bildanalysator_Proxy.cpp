...
Bildanalysator_Proxy::Bildanalysator_Proxy(string ipBildanalysator)
  : ipAdressSPBildanalysator(ipBildanalysator)
{
    std::cout << "Talking to SPBildanalysator on '" << ipAdressSPBildanalysator << "'\n";
...
void Bildanalysator_Proxy::bildanalyseStarten(Bildanalysator_Proxy::ObjektTyp suessigkeit)
{
//    Bildanalysator_Proxy::sendmessage(std::to_string(suessigkeit+1),"192.168.1.203",5842);
    Bildanalysator_Proxy::sendmessage(std::to_string(suessigkeit+1),ipAdressSPBildanalysator,5842);
}
